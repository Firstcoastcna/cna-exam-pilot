      ...
      <div style={{ maxWidth: "740px", margin: "0 auto", paddingTop: "4px" }}>
        ...
        <div style={{ display: "grid", gap: "16px" }}>
          ...
          >
            ...
            <div>{t("Inside the Exam Hub, you can also open a brief study-chapters guide for a quick review of the main ideas before testing.", "Dentro del Centro de Examenes, tambien puede abrir una guia breve de capitulos de estudio para repasar rapidamente las ideas principales antes del examen.", "Dans le hub d'examen, vous pouvez aussi ouvrir un guide bref des chapitres d'etude pour revoir rapidement les idees principales avant de commencer.", "Anndan Hub Egzamen an, ou ka louvri tou yon gid kout sou chapit etid yo pou revize ide prensipal yo rapidman anvan ou teste.")}</div>
          </Section>
